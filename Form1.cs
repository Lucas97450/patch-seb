...
namespace patch_seb_lucas
{
    public partial class Form1 : Form
    {
		...
		private void Form1_Load(object sender, EventArgs e)
		{
			...
			{
				AddLog("⚠️ Avertissement: Ce correctif a été développé dans le cadre d’un projet de recherche visant à identifier des vulnérabilités à des fins pédagogiques. Ne pas utiliser pour tricher ni pour commettre du plagiat — toute utilisation frauduleuse est illégale.");
